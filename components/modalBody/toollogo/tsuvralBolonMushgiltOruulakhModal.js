...
function TsuvralBolonMushgiltOruulakhModal({
  ...
  return (
    <>
      <Button onClick={openModal}>Цуврал нэмэх</Button>
                    ...
                    <Space
                      ...
                      <Form.Item
                        ...
                        rules={[
                          {
                            required: true,
                            message: "Цуврал оруулаагүй байна.",
                          },
                        ]}>
                        <Input className={"w-full"} placeholder="Цуврал " />
                      </Form.Item>
                      <Form.Item
                        style={{
                          width: "189px",
...
export default TsuvralBolonMushgiltOruulakhModal;
