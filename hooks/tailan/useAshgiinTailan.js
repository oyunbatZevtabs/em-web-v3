...
function useAshgiinTailan(token, shuult, khuudasniiKhemjee, searchKeys, order) {
  ...
  const { data, mutate, isValidating } = useSWR(
    !!token
      ? ["/ashigiinTailanAvya", token, shuult, khuudaslalt, searchKeys, order]
      : null,
    fetcher,
...
export default useAshgiinTailan;
