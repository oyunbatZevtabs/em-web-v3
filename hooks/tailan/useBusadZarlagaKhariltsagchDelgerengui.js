...
function useBusadZarlagaKhariltsagchDelgerengui(
  token,
  khariltsagchDelgerenguiShuult,
  searchKeys,
  order,
  khuudasniiKhemjee
) {
  ...
  const { data, mutate, isValidating } = useSWR(
    !!token
      ? [
          "/zarlagaAktKhariltsagchDelgerenguiTailan",
          token,
          khariltsagchDelgerenguiShuult,
          khuudaslalt,
          searchKeys,
...
export default useBusadZarlagaKhariltsagchDelgerengui;
