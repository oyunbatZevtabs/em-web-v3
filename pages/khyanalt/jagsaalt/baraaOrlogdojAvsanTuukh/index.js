...
function BaraaOrlogdojAvsanTuukh() {
  ...
  const { baiguullagiinId, salbariinId, baiguullaga, ajiltan, token } =
    useAuth();
            ...
            <div className="flex flex-col px-7">
              {text && (
                <div className="flex justify-between gap-2">
                  ...
                  <div>{formatNumber(data?.niitDun)}</div>
                </div>
              )}
            </div>
          );
...
export default BaraaOrlogdojAvsanTuukh;
